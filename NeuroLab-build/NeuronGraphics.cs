...
namespace Neuron{
    public partial class NeuronGraphics : UserControl{
        ...
        public enum NeuronNetType{LINEAR=0,KOHONEN=1,HOPFIELD=2,RBF=3,SHUFFLE=4}
        public enum Task{
            NONE,
            RECOGNIZE_IMAGE,
            RESTORE_IMAGE,
        ...
        private void ChangeBimapSettings(){
            ...
            paintArgs = new PaintEventArgs(
                splitContainer1.Panel1.CreateGraphics(), splitContainer1.Panel1.ClientRectangle);
        }
