...
namespace Neuron{
    public partial class NeuronInformation : Form{
        ...
        Drawer drawer;
        float f(float x){return (float)Math.Sin(x);}
        public NeuronInformation(Neuron neuron){
            ...
            drawer = new Drawer(this, new Rectangle(
                10, functionBox.Location.Y+functionBox.Height+20, Width-30,
                Height-functionBox.Height-100));
