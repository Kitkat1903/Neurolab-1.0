    ...
    public partial class ParameterListForm : Form{
        ...
        private void ParametrGrid_CellValueChanged(object sender,DataGridViewCellEventArgs e){
            if (e.ColumnIndex>=0 && e.RowIndex>=0){
                ...
                if (e.ColumnIndex==1) net.Inputs[e.RowIndex].Name=
                        (string)ParametrGrid.Rows[e.RowIndex].Cells[e.ColumnIndex].Value;
                else net.Inputs[e.RowIndex].value=
                        float.Parse(ParametrGrid.Rows[e.RowIndex].Cells[e.ColumnIndex].Value.ToString());
            }
        }
