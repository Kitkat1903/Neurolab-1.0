    ...
    public partial class ColorGridForm : Form
    {
        ...
        protected virtual void RecognizePicture(object sender, EventArgs e)
        {
            if (pairsLoaded)
            {
                ...
                {
                    resultString += string.Format("Образ : {0} Вероятность : {1}%",
                        net.recognitionResults[i].pair.name,net.recognitionResults[i].result)
                        +Environment.NewLine;
                }
        ...
        private void загруженныеОбразыToolStripMenuItem_Click(object sender, EventArgs e)
        {
