...
namespace Neuron{
    public class DataComboBox : ComboBox{
        ...
        public int DataIndex{
            ...
            set{
                Text=(string)table.Select(string.Format("{0} = {1}",
                    indexColumnName,value))[0].ItemArray[shownColumnIndex]; 
            }
        }
        ...
        protected override void OnSelectedIndexChanged(EventArgs e){
            currentIndex = (int)table.Select(string.Format("{0} like '{1}'",
                shownColumnName,Text))[0].ItemArray[indexColumnIndex];            
